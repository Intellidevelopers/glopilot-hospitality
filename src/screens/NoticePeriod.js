...
import { StyleSheet, View, Text, TouchableOpacity, TextInput, Modal, FlatList } from 'react-native';
...
const NoticePeriodScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('NoticeBoard')}>
